...
pub mod EspTokenV2 {
    ...
    impl alloy_sol_types::SolInterface for EspTokenV2Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<EspTokenV2Calls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
    ...
    impl alloy_sol_types::SolInterface for EspTokenV2Errors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<EspTokenV2Errors>] =
                &[
                    {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<EspTokenV2Instance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for EspTokenV2Instance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("EspTokenV2Instance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > EspTokenV2Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<EspTokenV2Instance<T, P, N>> {
